    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(signup_fac.this, "final "+url, Toast.LENGTH_SHORT).show();
                      ...
                      // url = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
                         taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                url= String.valueOf(Uri.parse(uri.toString()));
                                mFirebaseDatabase=FirebaseDatabase.getInstance();
                            //    mFirebaseDatabase.getReference().child("temporary_faculty").child(phnno.getText().toString()).child("url").setValue(url);
                                Toast.makeText(signup_fac.this, "resume upd " + url, Toast.LENGTH_SHORT).show();
                                ...
                                mFirebaseDatabase = FirebaseDatabase.getInstance();
                                //selectedItemText
                                mFirebaseDatabase.getReference().child("temporary_faculty").child(phnno.getText().toString()).child("f_subjects").setValue(selectedItemText);
                           }
