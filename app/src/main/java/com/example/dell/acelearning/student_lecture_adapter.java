...
public class student_lecture_adapter extends RecyclerView.Adapter<student_lecture_adapter.ViewHolder> {
    TextView lectures;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.lectures,parent,false);
    ...
    public student_lecture_adapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> lecs,ArrayList<String> lecs_date,ArrayList<String> lecs_url) {
